...
if ( ! class_exists( 'Automobile_Car_Services_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Automobile_Car_Services_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Automobile_Car_Services_WPTT_WebFont_Loader( $url );
